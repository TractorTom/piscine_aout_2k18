...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/08/05 18:10:40 by edjubert          #+#    #+#             */
/*   Updated: 2018/08/05 19:28:08 by edjubert         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if ((row == 0 && height == 0) || (row == max_row && height == 0))
		ft_putchar('A');
	else if ((row == 0 && height == max_height) ||
